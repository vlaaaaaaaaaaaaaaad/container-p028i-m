...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-p028i-m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-p028i-m.containers.anotherwebservice.com/
...
```
git clone git@github.com:vlaaaaaaaaaaaaaaad/container-p028i-m.git
cd container-p028i-m
```
...
```
docker attach container-p028i-m
```
